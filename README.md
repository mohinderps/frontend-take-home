...
We want you to implement the following frontend design (Refer to the Figma link mentioned below in the Resources section to see the full UI flow and design in detail):
